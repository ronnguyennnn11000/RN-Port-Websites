...
function DisplayCard({
  ...
  return (
    <div
      className={cn(
        "relative flex h-36 w-[22rem] -skew-y-[8deg] select-none flex-col justify-between rounded-xl border-2 border-white/10 backdrop-blur-sm px-4 py-3 transition-all duration-700 after:absolute after:-right-1 after:top-[-5%] after:h-[110%] after:w-[20rem] after:bg-gradient-to-l after:from-black after:to-transparent after:content-[''] hover:border-white/20 [&>*]:flex [&>*]:items-center [&>*]:gap-2",
        className
      )}
      style={{
        background: 'linear-gradient(145deg, #161616 0%, #111111 60%, #0e0e0e 100%)',
        boxShadow: '0 2px 4px rgba(0,0,0,0.3), 0 12px 40px rgba(0,0,0,0.45), 0 0 0 1px rgba(255,255,255,0.04), inset 0 1px 0 rgba(255,255,255,0.05)',
      }}
    >
      <div>
        <span className="relative inline-block rounded-full bg-[#1a1a1a] p-1">
          {icon}
        </span>
